 ...
 */
class ilObjFilePreviewGUI implements ilCtrlBaseClassInterface
{
    ...
    public function __construct(
        ...
        $this->activated = $settings->isPreviewEnabled() && $settings->isPreviewPossible();
        ...
        $this->preview_size = $settings->getImageSize();
        $this->pages_to_extract = $settings->getMaximumPreviews();
        $this->flavour_definition = new PagesToExtract(
            false,
            $this->preview_size,
            $this->pages_to_extract
        );
    }
    ...
    public function getTriggerComponents(bool $bulky = false): array
    {
    ...
    public function getRenderedTriggerComponents(bool $bulky = false): string
    {
        return $this->ui_renderer->render($this->getTriggerComponents($bulky));
    }
    ...
    private function getAsyncModal(): void
    {
        ...
        $pages = array_map(function (string $url): LightboxImagePage {
